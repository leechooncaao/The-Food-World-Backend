...
public interface CommentRepository extends JpaRepository<Comment, Integer> {
    ...
    @Query(value ="select new com.thefoodworld.model.dto.CommentDTO(c.commentId, c.commentContent, c.commentImage, c.food.foodId, c.account.accountId, c.commentTime, r.ratingLevel)\n" +
            "from Comment as c\n" +
